...
namespace Compliance.Entities
{
	...
	public partial class opc_reminder : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Compliance.Entities.opc_reminderState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Compliance.Entities.opc_reminderState)(System.Enum.ToObject(typeof(Compliance.Entities.opc_reminderState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public Compliance.Entities.BusinessUnit business_unit_opc_reminder
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Compliance.Entities.BusinessUnit>("business_unit_opc_reminder", null);
			}
		}
		...
		public Compliance.Entities.SystemUser lk_opc_reminder_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Compliance.Entities.SystemUser>("lk_opc_reminder_createdby", null);
			}
		}
		...
		public Compliance.Entities.SystemUser lk_opc_reminder_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Compliance.Entities.SystemUser>("lk_opc_reminder_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_opc_reminder_createdonbehalfby");
				this.SetRelatedEntity<Compliance.Entities.SystemUser>("lk_opc_reminder_createdonbehalfby", null, value);
		...
		public Compliance.Entities.SystemUser lk_opc_reminder_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Compliance.Entities.SystemUser>("lk_opc_reminder_modifiedby", null);
			}
		}
		...
		public Compliance.Entities.SystemUser lk_opc_reminder_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Compliance.Entities.SystemUser>("lk_opc_reminder_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_opc_reminder_modifiedonbehalfby");
				this.SetRelatedEntity<Compliance.Entities.SystemUser>("lk_opc_reminder_modifiedonbehalfby", null, value);
		...
		public Compliance.Entities.opc_complaint opc_complaint_reminders_complaint
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Compliance.Entities.opc_complaint>("opc_complaint_reminders_complaint", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("opc_complaint_reminders_complaint");
				this.SetRelatedEntity<Compliance.Entities.opc_complaint>("opc_complaint_reminders_complaint", null, value);
		...
		public Compliance.Entities.Team team_opc_reminder
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Compliance.Entities.Team>("team_opc_reminder", null);
			}
		}
		...
		public Compliance.Entities.SystemUser user_opc_reminder
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Compliance.Entities.SystemUser>("user_opc_reminder", null);
			}
		}
	}
}